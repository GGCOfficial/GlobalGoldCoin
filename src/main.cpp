...
const string strMessageMagic = "Global Gold Coin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 == 1000000001)
    {
      return nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GlobalGoldCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "March 30, 2016 Bitcoin Exchange Cointrader Shuts Down After Alleged Hack";
        CTransaction txNew;
        txNew.nTime = 1459491012;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1459491012;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3649102;
		if(fTestNet)
        {
            block.nNonce   = 3649102;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x4502f34c2e072e9d39c6cd1de58f29e6dda0e9f093e489780fec8d839b76c017"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd1, 0xf4, 0xf9, 0xc8 };
