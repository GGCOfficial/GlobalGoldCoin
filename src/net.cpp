...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("GlobalGoldCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("GlobalGoldCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("GlobalGoldCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Global Gold Coin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
        {"146.185.142.41", "146.185.142.41"},
        {"146.185.142.49", "146.185.142.49"},
        {"45.55.208.58", "45.55.208.58"},
        {"45.55.208.60", "45.55.208.60"},
        {"128.199.255.51", "128.199.255.51"},
        {"128.199.138.187", "128.199.138.187"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("GlobalGoldCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("GlobalGoldCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("GlobalGoldCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("GlobalGoldCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Global Gold Coin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("GlobalGoldCoin-start");
